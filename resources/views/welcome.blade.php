            ...
            <div id="rev_slider" class="rev_slider tp-overflow-hidden fullscreenbanner">
                <ul>
                    ...
                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="1000"
                        ...
                        <img src="{{ asset('theme/images/slider/slide1.jpg') }}" data-bgparallax="5" alt=""
                        ...
                        <div class="slider-title tp-caption"
                            ...
                            <a href="index.html" class="link-arrow">See project <i
                    ...
                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="1000"
                        ...
                        <img src="{{ asset('theme/images/slider/slide2.jpg') }}" data-bgparallax="5" alt=""
                             data-bgposition="center 0"
                             data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
                    ...
                    <li data-transition='slideleft' data-slotamount='default' data-masterspeed="1000"
                        ...
                        <img src="{{ asset('theme/images/slider/slide3.jpg') }}" data-bgparallax="5" alt=""
                             data-bgposition="center 0"
                             data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
